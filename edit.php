...
if (isset($_POST["submit"])) {
  ...
  $sql = "UPDATE `convidados` SET `nome`='$nome',`email`='$email',`telefone`='$telefone',`numero_acompanhantes`='$num_acomp' WHERE id = $id";

  $result = mysqli_query($conn, $sql);

  if ($result) {
    header("Location: dashboard.php?msg=Dados atualizados com êxito!");
  } else {
...
<body>
  ...
  <div class="container">
    <div class="text-center mb-4">
      <h3>Edição de informação dos convidados</h3>
      <p class="text-muted">Clique em Atualizar para mudar alguma informação.</p>
    </div>
    ...
    <div class="container d-flex justify-content-center">
      <form action="" method="post" style="width:50vw; min-width:300px;">
        ...
        <div class="form-group mb-3">
            ...
            <input type="number" class="form-control" name="num_acomp" value="<?php echo $row['numero_acompanhantes'] ?>">
        </div>
