...
<body>
  ...
  <div class="container">
    ...
    ?>
    <a href="add-new.php" class="btn btn-dark mb-3">Novo convidado</a>
    <a href="query_pdf.php" class="btn btn btn-secondary mb-3">Gerar PDF</a>
      ...
      <tbody>
        ...
        ?>
          <tr>
            ...
            <td><?php echo $row["numero_acompanhantes"] ?></td>
            <td>
